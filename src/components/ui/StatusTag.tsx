...
function StatusTag({ value, severity = "info", className = "", style }: StatusTagProps) {
  ...
  return (
    <Tag
      value={value}
      className={`rounded border! bg-transparent! px-2.5 py-1 text-xs font-bold ${colorClass} ${className}`}
      style={{
        borderWidth: "1px",
        boxShadow: "none",
        ...style,
