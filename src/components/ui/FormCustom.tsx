...
import { useRenderFormCustom } from ".";
...
export interface FormField {
  ...
  render?: (fieldProps: { value: any; onChange: (val: any) => void }) => React.ReactNode;
...
const FormCustom = forwardRef<FormRef, FormCustomProps>(function FormCustom(
  ...
  const { renderField, getValues, setValues, resetFields, validateFields } = useRenderFormCustom(
    fields,
    initialValues,
    onChangeValue,
  );
